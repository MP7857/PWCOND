...
implicit none
  ...
  ! small_eps: regularization for 1/r^3 singularity at small zsl values
  real(DP), parameter :: small_eps=1.d-10
       ...
       if (abs(zsl(kz))+eps.le.taunew(4)*alat) then
         ...
         elseif (lb.eq.3) then
            ...
            if(iz.eq.1) then
               ...
               ! Use small_eps for regularization of 1/r^3 singularity at small zsl
